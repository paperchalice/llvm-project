...
struct Loc {
  ...
  yaml::Hex64 Offset;
  Loc() = default;
  Loc(const llvm::object::MMOLoc &L);
  void writeAsBinary(raw_ostream &OS) const;
};
...
struct Skip {
  ...
  Skip(const llvm::object::MMOSkip &S);
  void writeAsBinary(raw_ostream &OS) const;
};
...
struct Fixo {
  ...
  yaml::Hex64 P;
  Fixo() = default;
  Fixo(const llvm::object::MMOFixo &F);
  void writeAsBinary(raw_ostream &OS) const;
};
...
struct Fixr {
  ...
  yaml::Hex16 Delta;
  Fixr(const llvm::object::MMOFixr &F);
  Fixr() = default;
  void writeAsBinary(raw_ostream &OS) const;
};
...
struct Fixrx {
  ...
  std::int32_t Delta;
  Fixrx() = default;
  Fixrx(const llvm::object::MMOFixrx &F);
  void writeAsBinary(raw_ostream &OS) const;
};
...
struct File {
  ...
  std::uint8_t Number;
  File() = default;
  File(const llvm::object::MMOFile &F);
  void writeAsBinary(raw_ostream &OS) const;
};
...
struct Line {
  ...
  std::uint16_t Number;
  Line() = default;
  Line(const llvm::object::MMOLine &L);
  void writeAsBinary(raw_ostream &OS) const;
};
...
struct Pre {
  ...
  Pre() = default;
  Pre(const llvm::object::MMOPre &P);
  void writeAsBinary(raw_ostream &OS) const;
};
...
struct Post {
  ...
  Post() = default;
  Post(const llvm::object::MMOPost &P);
  void writeAsBinary(raw_ostream &OS) const;
};
...
using Segment = std::variant<RawData, Quote, Loc, Skip, Fixo, Fixr, Fixrx, File, Line, Spec>;
