...
% CHECK:      HighByte:        DATA
% CHECK:      Offset:          0x0
% CHECK:    - Bin:             2404FC013F04FC01808182838485868788898A8B8C8D8E8FF0000002F80000005F030405970304059F28F305EF28F305
% CHECK:    - OpCode:          LOC
...
% CHECK:    - OpCode:          LINE
% CHECK:      Number:          30
% CHECK:    - Bin:             
% CHECK:    - OpCode:          FIXR
% CHECK:      Delta:           0x4
% CHECK:    - Bin:             3005060748050000E6060100F6190006F9000000
% CHECK:    - OpCode:          FIXR
% CHECK:      Delta:           0x4
% CHECK:    - Bin:             
% CHECK:    - OpCode:          FIXR
% CHECK:      Delta:           0x4
% CHECK:    - Bin:             3208060748080000E6060100F6190006F9000000FEDCBA98
% CHECK:    - OpCode:          LINE
% CHECK:      Number:          160
% CHECK:    - Bin:             76543210FFEEDDCC
% CHECK:    - OpCode:          LINE
% CHECK:      Number:          161
% CHECK:    - Bin:             BBAA998834F300F6C1F2F400F60500F5F8000000
% CHECK:    - OpCode:          FIXR
% CHECK:      Delta:           0xC
% CHECK:    - Bin:             F504FFF8E307002C9E0707049F0704309A4604049B4604009C4604049D4604009503F115F4030000F6180003E3F2000121F304048F28F1188B07F12C8B06F128
% CHECK:    - OpCode:          FIXR
% CHECK:      Delta:           0x7
% CHECK:    - Bin:             3208060748080000E6060100F6190006C105F200F9000000
% CHECK:    - OpCode:          FIXR
% CHECK:      Delta:           0x5
% CHECK:    - Bin:             3928FE333928FE34FAFF0000F71300FEE7FD04000464FEC8F61500FDFF0164FE0664FEC8F714000AF61400FEF20B0001FB0000FF00000000
% CHECK:    - OpCode:          LOC
% CHECK:      HighByte:        INSTRUCTION
% CHECK:      Offset:          0x60
% CHECK:    - OpCode:          LINE
% CHECK:      Number:          204
% CHECK:    - Bin:             F2FF00000000000125000101F8020000FE320019E4328100093C0001F61B003CF0000000
% CHECK:    - OpCode:          LOC
% CHECK:      HighByte:        INSTRUCTION
% CHECK:      Offset:          0x0
% CHECK:    - OpCode:          LINE
% CHECK:      Number:          215
% CHECK:    - Bin:             FE320019E4328200E532FB0000000001
% CHECK:    - OpCode:          FIXRX
% CHECK:      FixType:         JMP
% CHECK:      Delta:           -28
% CHECK:    - Bin:             F6190032FEFF0000F9000000
% CHECK:    - OpCode:          FIXRX
% CHECK:      FixType:         OTHERWISE
% CHECK:      Delta:           -17
% CHECK:    - Bin:             E305ABCDFE010004F2030010240A0304F6040001F80B0003
% CHECK:  Postamble:
% CHECK:    G:               241
